...
<body>
    ...
    <div class="container my-5">
        <h2 class="text-center">Store Reservation</h2>
        <form action="" method="post">
            ...
            <button type="submit" name="reserve" class="btn btn-primary">Submit Reservation</button>
        </form>
    </div>
    ...
    if (isset($_POST['reserve'])) {
        ...
        $sql = "INSERT INTO reservations (name, email, phone, company, reservation_date, message) VALUES ('$name', '$email', '$phone', '$company', '$reservation_date', '$message')";

        if ($conn->query($sql) === TRUE) {
            echo "<div class='container'><div class='alert alert-success' role='alert'>Reservation successful!</div></div>";
        } else {
