...
<body>
    ...
    <!-- Cancel Reservation Form Start -->
    <div class="container my-5">
        <h2 class="text-center">Cancel Store Reservation</h2>
    ...
    if (isset($_POST['cancel'])) {
        ...
        if ($conn->query($sql) === TRUE) {
            echo "<div class='container'><div class='alert alert-success' role='alert'>Reservation canceled successfully!</div></div>";
        } else {
